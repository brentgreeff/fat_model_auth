...
@good_user.stub!(:allows).and_return(FatModelAuth::CannedGateKeeper.allows(:edit))

or

@no_good_user.stub!(:allows).and_return(FatModelAuth::CannedGateKeeper.denies(:edit))
